...
Then(`devera visualizar os resultados com todo os médicos do Rio de Janeiro`, (resultado) => {
	AutomationPesquisa.visualizar_resultados(resultado)
});


Then(`devera visualizar a Especialidade e Cidade de cada médico`, (EspecialidadeCidade) => {
